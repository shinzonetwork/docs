...
To make this concrete, let's follow a single USDC transfer on Ethereum Mainnet from the moment it lands on-chain to the moment an app shows it to a user.
