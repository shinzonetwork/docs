...
1. Install Foundry:
    ...
    Add this export to your shells `rc` file (`.bashrc`, `.zshrc`, `~/.config/fish/config.fish`, etc):

    ```shell
    export PATH="$PATH:/home/johnny/.foundry/bin"
    ```
...
1. Follow the [official Docker install guide](https://docs.docker.com/engine/install/ubuntu/) for Ubuntu.
...
```output
"0xf2a1e49ccfac253639fd75d263ec521270d2ddccb04ad722298104e4699abd86"
```
...
```output
49.3.101.20 172.17.0.1 2a01:4f8:...
```
