...
+++
Shinzo runs on a few ideas that show up everywhere in the stack: Views, Pools, Attestation, and DefraDB. The [How it works](../how-it-works/) page covers how they fit together end to end.

Each concept has its own page below:
