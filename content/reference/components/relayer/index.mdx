...
1. Resolves the pointer to an attestation on the ChallengeIssuer contract.
1. Verifies the EIP-712 signatures.
1. Sends `MsgIndexerAssertion` to ShinzoHub as a Cosmos SDK transaction.
