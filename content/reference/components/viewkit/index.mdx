...
1. An SDL -- GraphQL schema defining the output shape.
1. A lens (optional) -- WASM module that transforms the data.
...
2. viewkit view deploy
   -> encodes VWL        3. View Registry (0x0210)
   -> EVM tx                -> validate bundle
                             -> RegisterObject (ICA)
