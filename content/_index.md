...
You'll need a machine that stays online reliably. A Host doesn't need to be close to a blockchain node, but a stable connection and plenty of disk is recommended. See the [hardware requirements](/hosts/hardware-requirements/) for sizing.
