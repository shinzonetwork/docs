...
description = "Build applications with and on the Shinzo network: query live Views, create your own View, or build a local-first app with verifiable data reads."
+++
